...
Pinterest Ads CLI & Skills for AI agents (and humans). Analyze campaign performance, browse product catalogs, discover regional search trends, pull analytics with attribution windows, and more.
...
> Install this CLI and skills from https://github.com/Bin-Huang/pinterest-ads-cli
